...
Benchmark("intruder-nfs","stamp","small", "-t", " -a10 -l4 -n2048 -s1"  ,         dir_stamp + "/intruder-no-fsharing", "intruder")
Benchmark("intruder-qs", "stamp","small", "-t", " -a10 -l4 -n2048 -s1"  ,         dir_stamp + "/intruder-queuesync", "intruder")
Benchmark("kmeans-l", "stamp",   "small", "-p", "-m40 -n40 -t0.05 -i inputs/random-n2048-d16-c16.txt", dir_stamp + "/kmeans",  "kmeans")
Benchmark("kmeans-qs-l", "stamp", "small","-p", "-m40 -n40 -t0.05 -i inputs/random-n2048-d16-c16.txt", dir_stamp + "/kmeans-queuesync",  "kmeans")
Benchmark("kmeans-h", "stamp",   "small", "-p", "-m15 -n15 -t0.05 -i inputs/random-n2048-d16-c16.txt", dir_stamp + "/kmeans", "kmeans")
Benchmark("kmeans-qs-h", "stamp","small", "-p", "-m15 -n15 -t0.05 -i inputs/random-n2048-d16-c16.txt", dir_stamp + "/kmeans-queuesync", "kmeans")
...
Benchmark("intruder-nfs","stamp","medium", "-t", " -a10 -l16 -n4096 -s1",          dir_stamp + "/intruder-no-fsharing", "intruder")
Benchmark("intruder-qs","stamp", "medium", "-t", " -a10 -l16 -n4096 -s1",          dir_stamp + "/intruder-queuesync", "intruder")
Benchmark("kmeans-l", "stamp",   "medium", "-p", "-m40 -n40 -t0.05 -i inputs/random-n16384-d24-c16.txt", dir_stamp + "/kmeans",  "kmeans")
Benchmark("kmeans-qs-l", "stamp","medium", "-p", "-m40 -n40 -t0.05 -i inputs/random-n16384-d24-c16.txt", dir_stamp + "/kmeans-queuesync",  "kmeans")
Benchmark("kmeans-h", "stamp",   "medium", "-p", "-m15 -n15 -t0.05 -i inputs/random-n16384-d24-c16.txt", dir_stamp + "/kmeans", "kmeans")
Benchmark("kmeans-qs-h", "stamp","medium", "-p", "-m15 -n15 -t0.05 -i inputs/random-n16384-d24-c16.txt", dir_stamp + "/kmeans-queuesync", "kmeans")

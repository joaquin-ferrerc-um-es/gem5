...
configs_vary(
    ...
    templates.htm_cfg1_l1rsetevict_pf_dwng_lazycd_magic_rw,
    templates.htm_cfg1_l1rsetevict_pf_dwng_lazycd_token_cw,
    templates.htm_cfg1_l1rsetevict_pf_dwng_precise,
    templates.htm_cfg1_l1rsetevict_pf_dwng_precise_reqstalls,
    templates.htm_cfg1_l1rsetevict_pf_dwng_precise_reqstalls_retry64,
    templates.htm_cfg1_l2rwsetevict_pf_dwng_precise_reqstalls_eagervm,
)
...
configs_update({
    ...
    num_processors: Vary(1, 2, 4, 8, 16),

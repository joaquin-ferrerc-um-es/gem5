...
for (name, subdir, exe_name, args, input) in [       
    ...
    ("cache_latency",  "kernels/cache-latency",                "CACHE-LATENCY",  "", None),
    ("0_cache_latency_1K",  "kernels/cache-latency",                "CACHE-LATENCY",  "1 K", None),
    ("1_cache_latency_4K",  "kernels/cache-latency",                "CACHE-LATENCY",  "4 K", None),
    ("2_cache_latency_8K",  "kernels/cache-latency",                "CACHE-LATENCY",  "8 K", None),
    ("3_cache_latency_16K",  "kernels/cache-latency",                "CACHE-LATENCY",  "16 K", None),
    ("4_cache_latency_32K",  "kernels/cache-latency",                "CACHE-LATENCY",  "32 K", None),
    ("5_cache_latency_64K",  "kernels/cache-latency",                "CACHE-LATENCY",  "64 K", None),
    ("6_cache_latency_128K",  "kernels/cache-latency",                "CACHE-LATENCY",  "128 K", None),
    ("7_cache_latency_256K",  "kernels/cache-latency",                "CACHE-LATENCY",  "256 K", None),
    ("8_cache_latency_512K",  "kernels/cache-latency",                "CACHE-LATENCY",  "512 K", None),
    ("9_cache_latency_1M",  "kernels/cache-latency",                "CACHE-LATENCY",  "1 M", None),
    ("10_cache_latency_4M",  "kernels/cache-latency",                "CACHE-LATENCY",  "4 M", None),
    ("11_cache_latency_8M",  "kernels/cache-latency",                "CACHE-LATENCY",  "8 M", None),
    ("12_cache_latency_16M",  "kernels/cache-latency",                "CACHE-LATENCY",  "16 M", None),
    ("13_cache_latency_32M",  "kernels/cache-latency",                "CACHE-LATENCY",  "32 M", None),
    ("14_cache_latency_64M",  "kernels/cache-latency",                "CACHE-LATENCY",  "64 M", None),
    ("15_cache_latency_128M",  "kernels/cache-latency",                "CACHE-LATENCY",  "128 M", None),
    ("MemLat",         "kernels/memlat",                       "MEMLAT",         "64 p6", None),
]:
    Benchmark(
        suite = "splash3",
        name = name,
